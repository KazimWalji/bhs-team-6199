 ...
 */
    ...
    @Autonomous(name = "BlueAutoNew", group = "Sky autonomous")
//@Disabled//comment out this line before using
        ...
        public void runOpMode() throws InterruptedException {
            ...
            while (opModeIsActive()) {
                ...
                if (valLeft == 0) {
                    ...
                    encoder(1530, 1030, 1030, 1530, .3, 7);
                    armServo.setPosition(.75);
                    sleep (400);
                    encoder(-190, -190, -190, -190, .5, 3);
                    encoder(-630, 630, -630, 630, .5 , 2);
                    ...
                    encoder(2250, 2250, 2250, 2500, .4, 7);
                    armServo.setPosition(.5);
                    sleep(1000);

                    encoder(-1050, -1050, -1050, -1050, .4, 7);
                    turnAngle(-3, 3, .3, .3, -.3, -.3);

                    encoder(440, 440, 440, 440, .1, 3);
                    armServo.setPosition(.75);
                    sleep(1000);
                    encoder(-300, -300, -300, -300, .3, 3);

                    turnAngle(85, 93, -.3, -.3, .3, .3);
                    encoder(2000, 2000, 2000, 2000, .8, 7);
                    armServo.setPosition(.5);
                    sleep(1000);
    ...
    public void encoder(int lf, int rf, int lr, int rr, double pow, int sec) {
        ...
        leftFront.setPower(pow);
        runTime.reset();
        while ((rightRear.isBusy() || leftRear.isBusy() || rightFront.isBusy()
                || leftFront.isBusy()) && opModeIsActive() && runTime.seconds() < sec) {
