    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (valLeft == 0) {
                ...
                telemetry.update();
                encoder(990, 1490, 1490, 990, .2, 6);
                armServo.setPosition(.77);
                sleep(500);
                encoder(-210, -210, -210, -210, .5, 3);
                encoder(630, -630, 630, -630, .5 , 2);
                turnAngle(271.5, 272.5, .2, .2, -.2, -.2);
                encoder(2500, 2500, 2500, 2500, .5, 7);
                armServo.setPosition(.5);
                sleep(400);
                checkAngle(272,273);
                encoder(-2990, -2990, -2990, -2990, .4, 7);

                turnAngle(30, 40, -.3, -.3, .3, .3);

                encoder(700, 600, 700, 600, .2, 3);
                armServo.setPosition(.75);
                sleep(500);
                encoder(-500, -500, -500, -500, .3, 3);
                encoder(630, -630, 630, -630, .5 , 2);
                turnAngle(271.5, 272.5, .2, .2, -.2, -.2);
                encoder(3300, 3300, 3300, 3300, .5, 7);
                armServo.setPosition(.5);
                sleep(1000);
                ...
                encoder(1350, 1050, 1050, 1350, .3, 7);
                armServo.setPosition(.75);
                sleep (400);
                ...
                encoder(-2880, -2880, -2880, -2880, .3, 7);
                encoder(-630, 630, -630, 630, .5 , 20);
                turnAngle(-2, 1, -.2, -.2, .2, .2);
                encoder(150, 150, 150, 150, .1, 3);
                armServo.setPosition(.75);
                sleep(400);
                encoder(-250, -250, -250, -250, .3, 3);
                encoder(630, -630, 630, -630, .5 , 10);
                turnAngle(272, 273, .2, .2, -.2, -.2);
                ...
                encoder(1800, 600, 600, 1800, .3, 5);
                armServo.setPosition(.75);
                sleep(1000);
                encoder(-170, -170, -170, -170, .5, 3);
                encoder(630, -630, 630, -630, .5 , 1);
                turnAngle(271.5, 272.5, .2, .2, -.2, -.2);
                encoder(1700, 1700, 1700, 1700, .4, 7);
                checkAngle(272,273);
                armServo.setPosition(.5);
                sleep(400);
                encoder(-2740, -2740, -2740, -2740, .5, 7);
