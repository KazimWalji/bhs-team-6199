...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public TrajectoryBuilder trajectoryBuilder(Pose2d startPose, boolean reverse) {
        return new TrajectoryBuilder(startPose, reverse, constraints);
    }
